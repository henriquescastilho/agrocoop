...
import { LayoutDashboard, Map, ClipboardList, Truck, Settings, LogOut, PanelLeft, Shield, MessageCircle } from "lucide-react";
        ...
        <div className="flex h-screen overflow-hidden bg-background">
            ...
            <aside className="hidden w-72 border-r border-white/10 bg-card/50 backdrop-blur-xl md:flex flex-col">
                ...
                <div className="p-4 border-t border-white/10 space-y-2">
                    <Button variant="ghost" className="w-full justify-start gap-3 text-blue-400 hover:bg-blue-400/10 hover:text-blue-400" asChild>
